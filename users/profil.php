      ...
      <div class="container align-items-center">
        <div class="row">
          <div class="col-lg-6 col-md-6">
            ...
            <p class="profile-description">Offices parties lasting outward nothing age few resolve. Impression to
              ...
              <div class="card-body">
                ...
                <div class="tab-content tab-subcategories">
                  ...
                  <div class="tab-pane" id="linkb">
                    ...
                    <button type="submit" class="btn btn-simple btn-primary btn-icon btn-round float-right"><i
      ...
      <div class="container">
        <div class="row justify-content-between">
          ...
          <div class="col-md-5">
            ...
            <p class="profile-description text-left">An artist of considerable range, Ryan — the name taken by
