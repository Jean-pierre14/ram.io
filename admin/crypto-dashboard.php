...
<!-- Mirrored from demo.dashboardpack.com/kero-html-sidebar-pro/crypto-dashboard.html by HTTrack Website Copier/3.x [XR&CO'2014], Sat, 01 May 2021 14:53:21 GMT -->
...
<head>
    ...
    <title>Cryptocurrency - This is an example dashboard created using build-in elements and components.</title>
                            ...
                            <ul class="vertical-nav-menu">
                                ...
                                >
                                    ...
                                    >
                                        ...
                                        <li><a  class="mm-active" href="crypto-dashboard.html">Cryptocurrency</a></li>
                                                                    ...
                                                                    <div class="widget-content p-0">
                                                                        <div class="widget-content-wrapper">
                                                                            ...
                                                                            <div class="widget-content-left flex2">
                                                                                ...
                                                                                <div class="widget-subheading opacity-7">Etiam
                                                                                    sit
                                                                                    amet orci eget
                                                                                </div>
                                                                            </div>
                                                ...
                                                <div class="mb-3 profile-responsive card">
                                                            ...
                                                            <div class="menu-header-content btn-pane-right">
                                                                <div class="avatar-icon-wrapper mr-3 avatar-icon-xl btn-hover-shine">
                                                                    <div class="avatar-icon rounded"><img
                                                                            src="assets/images/avatars/3.jpg" alt="Avatar 5">
                                                                    </div>
                                                                </div>
                                                                <div>
                                                    ...
                                                    <ul class="list-group list-group-flush">
                                                        ...
                                                        <b class="text-danger">12</b> new leads,
                                                                    ...
                                                                    <button class="btn-wide btn-pill btn btn-outline-primary">
                                                                        Full
                                                                        Report
                                                                    </button>
                                                                </div>
                                                        ...
                                                        <div class="dropdown-menu-header-inner bg-dark">
                                                            ...
                                                            <div class="menu-header-content btn-pane-right">
                                                                ...
                                                                <div>
                                                                    ...
                                                                    <h6 class="menu-header-subtitle">Short profile
                                                                        description</h6>
                                                                </div>
                                                                <div class="menu-header-btn-pane">
                                                                    <button type="button"
                                                                            class="btn-wide btn-shadow btn-pill btn btn-warning">
                                                                        Refresh
                                                                    </button>
                                                                </div>
                                                            </div>
                                                        ...
                                                        <div class="dropdown-menu-header-inner bg-dark">
                                                            ...
                                                            <div class="menu-header-content btn-pane-right">
                                                                ...
                                                                <div>
                                                                    ...
                                                                    <h6 class="menu-header-subtitle">Etiam sit amet orci
                                                                        eget</h6>
                                                                </div>
                                                                <div class="menu-header-btn-pane">
                                                                    <button class="btn btn-success">View Profile</button>
