...
<!-- Mirrored from demo.dashboardpack.com/kero-html-sidebar-pro/components-notifications.html by HTTrack Website Copier/3.x [XR&CO'2014], Sat, 01 May 2021 14:53:50 GMT -->
                                                            ...
                                                            <div class="row">
                                                                <div class="col-md-3">
                                                                    ...
                                                                    <div class="form-group">
                                                                        ...
                                                                        <div class="form-check">
                                                                            <input id="addBehaviorOnToastClick"
                                                                        ...
                                                                        <div class="form-check">
                                                                            <input disabled
                                                                                   ...
                                                                                   class="form-check-input"/>
                                                                            <label class="form-check-label"
                                                                                   for="addBehaviorOnToastCloseClick">
                                                                    ...
                                                                    <div id="toastTypeGroup">
                                                                        ...
                                                                        <div class="form-check">
                                                                            <input type="radio" name="toasts"
                                                                                   class="form-check-input" value="success"
                                                                                   checked/>
                                                                            <label class="form-check-label"
                                                                                   for="exampleRadios1">
                                                                                Success
                                                                        ...
                                                                        <div class="form-check">
                                                                            <input type="radio" name="toasts"
                                                                                   class="form-check-input" value="info"
                                                                                   checked/>
                                                                            <label class="form-check-label"
                                                                                   for="exampleRadios1">
                                                                                Info
                                                                        ...
                                                                        <div class="form-check">
                                                                            <input type="radio" name="toasts"
                                                                                   class="form-check-input" value="warning"
                                                                                   checked/>
                                                                            <label class="form-check-label"
                                                                                   for="exampleRadios1">
                                                                                Warning
                                                                        ...
                                                                        <div class="form-check">
                                                                            <input type="radio" name="toasts"
                                                                                   class="form-check-input" value="error"
                                                                                   checked/>
                                                                            <label class="form-check-label"
                                                                                   for="exampleRadios1">
                                                                                Error
                                                                ...
                                                                <div class="col-md-3">
                                                                    <div class="form-group">
                                                                        <label class="form-label" for="showDuration">Show
                                                                            Duration</label>
                                                                        <input id="showDuration" type="number"
                                                                               placeholder="ms" class="form-control"
                                                                               value="300"/>
                                                                    </div>
                                                                    <div class="form-group">
                                                                        <label class="form-label" for="hideDuration">Hide
                                                                            Duration</label>
                                                                        <input id="hideDuration" type="number"
                                                                               placeholder="ms" class="form-control"
                                                                               value="1000"/>
                                                                    </div>
                                                                    <div class="form-group">
                                                                        <label class="form-label" for="timeOut">Time
                                                                            out</label>
                                                                        <input id="timeOut" type="number" placeholder="ms"
                                                                               class="form-control" value="5000"/>
                                                                    </div>
                                                                    <div class="form-group">
                                                                        <label class="form-label" for="extendedTimeOut">Extended
                                                                            time out</label>
                                                                        <input id="extendedTimeOut" type="number"
                                                                               placeholder="ms" class="form-control"
                                                                               value="1000"/>
                                                                    </div>
                                                                </div>
                                                ...
                                                <div class="col-md-3">
                                                    <div class="mb-3 text-center card">
                                                        <div class="card-body"><h5 class="card-title">Success</h5>
                                                            <button type="button" data-type="success"
                                                                    class="btn btn-success btn-show-swal">Show Alert
                                                            </button>
                                                        </div>
                                                    </div>
                                                </div>
                                                <div class="col-md-3">
                                                    <div class="mb-3 text-center card">
                                                        <div class="card-body"><h5 class="card-title">Question</h5>
                                                            <button type="button" data-type="question"
                                                                    class="btn btn-primary btn-show-swal">Show Alert
                                                            </button>
                                                        </div>
                                                    </div>
                                                </div>
                                                <div class="col-md-3">
                                                    <div class="mb-3 text-center card">
                                                        <div class="card-body"><h5 class="card-title">Danger</h5>
                                                            <button type="button" data-type="danger"
                                                                    class="btn btn-danger btn-show-swal">Show Alert
                                                            </button>
                                                        </div>
                                                    </div>
                                                </div>
                                                <div class="col-md-3">
                                                    <div class="mb-3 text-center card">
                                                        <div class="card-body"><h5 class="card-title">Info</h5>
                                                            <button type="button" data-type="info"
                                                                    class="btn btn-info btn-show-swal">Show Alert
                                                            </button>
                                                        </div>
                                                    </div>
                                                </div>
                                                <div class="col-md-3">
                                                    <div class="mb-3 text-center card">
                                                        <div class="card-body"><h5 class="card-title">Warning</h5>
                                                            <button type="button" data-type="warning"
                                                                    class="btn btn-warning btn-show-swal">Show Alert
                                                            </button>
                                                        </div>
                                                    </div>
                                                </div>
                                                ...
                                                <div class="col-md-4">
                                                    <div class="mb-3 text-center card">
                                                        <div class="card-body"><h5 class="card-title">Example 1</h5>
                                                            <button type="button"
                                                                    class="btn btn-primary btn-show-swal-basic">Show Alert
                                                            </button>
                                                        </div>
                                                    </div>
                                                </div>
                                                <div class="col-md-4">
                                                    <div class="mb-3 text-center card">
                                                        <div class="card-body"><h5 class="card-title">Example 2</h5>
                                                            <button type="button"
                                                                    class="btn btn-primary btn-show-swal-basic-2">Show Alert
                                                            </button>
                                                        </div>
                                                    </div>
                                                </div>
                                                <div class="col-md-4">
                                                    <div class="mb-3 text-center card">
                                                        <div class="card-body"><h5 class="card-title">Custom Animation</h5>
                                                            <button type="button"
                                                                    class="btn btn-primary btn-show-swal-basic-3">Show Alert
                                                            </button>
                                                        </div>
                                                    </div>
                                                </div>
                                                ...
                                                <div class="col-md-6">
                                                    <div class="main-card mb-3 card">
                                                        <div class="card-body"><h5 class="card-title">Alerts</h5>
                                                            <div class="alert alert-primary fade show" role="alert">This is
                                                                a primary alert — check it out!
                                                            </div>
                                                            <div class="alert alert-secondary fade show" role="alert">This
                                                                is a secondary alert — check it out!
                                                            </div>
                                                            <div class="alert alert-success fade show" role="alert">This is
                                                                a success alert — check it out!
                                                            </div>
                                                            <div class="alert alert-danger fade show" role="alert">This is a
                                                                danger alert — check it out!
                                                            </div>
                                                            <div class="alert alert-warning fade show" role="alert">This is
                                                                a warning alert — check it out!
                                                            </div>
                                                            <div class="alert alert-info fade show" role="alert">This is a
                                                                info alert — check it out!
                                                            </div>
                                                            <div class="alert alert-light fade show" role="alert">This is a
                                                                light alert — check it out!
                                                            </div>
                                                            <div class="alert alert-dark fade show" role="alert">This is a
                                                ...
                                                <div class="col-md-6">
                                                    <div class="main-card mb-3 card">
                                                        <div class="card-body"><h5 class="card-title">Alerts Link Color</h5>
                                                            <div class="alert alert-primary fade show" role="alert">This is
                                                                a primary alert with <a href="javascript:void(0);"
                                                                                        class="alert-link">an example
                                                                    link</a>. Give it a click if you like.
                                                            </div>
                                                            <div class="alert alert-secondary fade show" role="alert">This
                                                                is a secondary alert with <a href="javascript:void(0);"
                                                                                             class="alert-link">an example
                                                                    link</a>. Give it a click if you like.
                                                            </div>
                                                            <div class="alert alert-success fade show" role="alert">This is
                                                                a success alert with <a href="javascript:void(0);"
                                                                                        class="alert-link">an example
                                                                    link</a>. Give it a click if you like.
                                                            </div>
                                                            <div class="alert alert-danger fade show" role="alert">This is a
                                                                danger alert with <a href="javascript:void(0);"
                                                                                     class="alert-link">an example link</a>.
                                                                Give it a click if you like.
                                                            </div>
                                                            <div class="alert alert-warning fade show" role="alert">This is
                                                                a warning alert with <a href="javascript:void(0);"
                                                                                        class="alert-link">an example
                                                                    link</a>. Give it a click if you like.
                                                            </div>
                                                            <div class="alert alert-info fade show" role="alert">This is a
                                                                info alert with <a href="javascript:void(0);"
                                                                                   class="alert-link">an example link</a>.
                                                                Give it a click if you like.
                                                            </div>
                                                            <div class="alert alert-light fade show" role="alert">This is a
                                                                light alert with <a href="javascript:void(0);"
                                                                                    class="alert-link">an example link</a>.
                                                                Give it a click if you like.
                                                            </div>
                                                            <div class="alert alert-dark fade show" role="alert">This is a
                                                                dark alert with <a href="javascript:void(0);"
                                                                                   class="alert-link">an example link</a>.
                                                                Give it a click if you like.
                                                            </div>
                                                        </div>
                                                ...
                                                <div class="col-md-6">
                                                    <div class="main-card mb-3 card">
                                                        <div class="card-body"><h5 class="card-title">Alerts Content</h5>
                                                            <div class="alert alert-success fade show" role="alert"><h4
                                                                    class="alert-heading">Well done!</h4>
                                                                ...
                                                                <p class="mb-0">Whenever you need to, be sure to use margin
                                                                    utilities to keep things nice and tidy.</p></div>
                                                        </div>
                                                    </div>
                                                </div>
                                                <div class="col-md-6">
                                                    <div class="main-card mb-3 card">
                                                        <div class="card-body"><h5 class="card-title">Dismissable
                                                            Alerts</h5>
