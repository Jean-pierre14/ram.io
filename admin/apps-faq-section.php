...
<!-- Mirrored from demo.dashboardpack.com/kero-html-sidebar-pro/apps-faq-section.html by HTTrack Website Copier/3.x [XR&CO'2014], Sat, 01 May 2021 14:53:28 GMT -->
...
<head>
    ...
    <title>FAQ Section - Kero HTML Bootstrap 4 Dashboard Template</title>
                        ...
                        <div class="app-header">
                            <div class="page-title-heading">
                                ...
                                <div class="page-title-subheading">
                                    Kero HTML Bootstrap 4 Dashboard Template
                                </div>
                            </div>
                                ...
                                <div class="p-3 stick-to-parent">
                                    <div class="dropdown-menu nav p-0 dropdown-menu-inline dropdown-menu-rounded dropdown-menu-hover-primary">
                                        ...
                                        <a href="#tab-faq-1" data-toggle="tab" tabindex="0"
                                           class="mb-1 active dropdown-item">Tab Example 1</a>
                                        <a href="#tab-faq-2" data-toggle="tab" tabindex="0" class="mb-1 dropdown-item">Tab
                                            Example 2</a>
                                        <a href="#tab-faq-3" data-toggle="tab" tabindex="0" class="mb-1 dropdown-item">Tab
                                            Example 3</a>
                                    </div>
                                </div>
                            </div>
                                ...
                                <div class="pb-5 pl-5 pr-5 pt-3">
                                    ...
                                    <div class="tab-content">
                                            ...
                                            <div id="accordion">
                                                <div class="card mb-1">
                                                    ...
                                                    <div data-parent="#accordion" id="collapseOne1"
                                                        ...
                                                        <div class="card-body">1. Anim pariatur cliche reprehenderit, enim
                                                ...
                                                <div class="card mb-1">
                                                    ...
                                                    <div data-parent="#accordion" id="collapseOne2" class="collapse">
                                                        <div class="card-body">2. Anim pariatur cliche reprehenderit, enim
                                                            eiusmod high life accusamus terry richardson ad squid. 3 wolf
                                                            moon officia aute, non cupidatat skateboard dolor brunch. Food
                                                            truck
                                                            quinoa
                                                ...
                                                <div class="card mb-1">
                                                    ...
                                                    <div data-parent="#accordion" id="collapseOne3" class="collapse">
                                                        <div class="card-body">3. Anim pariatur cliche reprehenderit, enim
                                                            eiusmod high life accusamus terry richardson ad squid. 3 wolf
                                                            moon officia aute, non cupidatat skateboard dolor brunch. Food
                                                            truck
                                                            quinoa
                                            ...
                                            <div class="clearfix">
                                                <div class="text-center">
                                                    <a href="javascript:void(0);"
                                                       class="btn-pill btn-wide btn-shadow btn btn-primary btn-lg">Maecenas
                                                        tempus, tellus</a>
                                                </div>
                                            </div>
                                        </div>
                                        <div class="tab-pane" id="tab-faq-2"><h4>Maecenas tempus, tellus</h4>
                                            ...
                                            <p>But who has any right to find fault with a man who chooses to enjoy a
                                        ...
                                        <div class="tab-pane" id="tab-faq-3"><h4>Maecenas tempus, tellus</h4>
                                            ...
                                            <p>Aenean leo ligula, porttitor eu, consequat vitae, eleifend ac, enim. Aliquam
                                            ...
                                            <p>Quisque rutrum. Aenean imperdiet. Etiam ultricies nisi vel augue. Curabitur
                                                ullamcorper ultricies nisi. Nam eget dui. Etiam rhoncus.</p>
                                            ...
                                            <div class="clearfix">
                                                <div class="text-center">
                                                    <button type="button"
                                                            class="btn-pill btn-wide btn-shadow btn btn-primary btn-lg">
