...
<!-- Mirrored from demo.dashboardpack.com/kero-html-sidebar-pro/components-guided-tours.html by HTTrack Website Copier/3.x [XR&CO'2014], Sat, 01 May 2021 14:53:52 GMT -->
                                                ...
                                                <div class="main-card mb-3 card mt-3">
                                                    <div class="card-body">
                                                        <div class="text-center">
                                                            <button class="btn btn-lg btn-success start-tour">Start Tour
                                                            </button>
                                                        </div>
                                                        <div class="divider"></div>
                                                        <div class="jumbotron" data-step="1"
                                                            ...
                                                            <p class="lead">
                                                                <a class="btn btn-primary btn-lg" data-step="2"
                                                                   data-intro="Ok, wasn't that fun?" data-position='right'
                                                                   data-scrollTo='tooltip' href="javascript:void(0);"
                                                        ...
                                                        <p data-step="3" data-intro="More features, more fun."
                                                           data-scrollTo='tooltip' data-position='left'>In enim justo,
                                                        ...
                                                        <p>Donec vitae sapien ut libero venenatis faucibus. Nullam quis
                                                            ...
                                                            a libero. Fusce vulputate eleifend sapien. Vestibulum purus
                                                            quam, scelerisque ut, mollis sed, nonummy id, metus.</p>
                                                        ...
                                                        <p>Nullam accumsan lorem in dui. Cras ultricies mi eu turpis
                                                            ...
                                                            consectetuer lacinia. Nam pretium
                                                        ...
                                                        <p>Integer ante arcu, accumsan a, consectetuer eget, posuere ut,
                                                            ...
                                                            Cras id dui. Aenean ut eros et
                                                            nisl
                                                            sagittis vestibulum. Nullam nulla eros, ultricies sit amet,
                                                            nonummy id, imperdiet feugiat, pede. Sed lectus. Donec mollis
                                                            hendrerit risus.</p>
                                                        <div class="jumbotron jumbotron-fluid" data-step="4"
                                                             data-intro="This is the end of the tour!" data-position='top'>
                                                            <div class="container">
                                                                <h1 class="display-4">Fluid jumbotron</h1>
                                                                <p class="lead" id="elem-tour-5">This is a modified
