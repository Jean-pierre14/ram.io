                                ...
                                <div>
                                    <div class="h-100 d-flex justify-content-center align-items-center bg-plum-plate" tabindex="-1">
                                        ...
                                        <div class="slider-content">
                                            ...
                                            <p><?= $prooject_name; ?> is like a dream. Some think it's too good to be true!</p>
                                        </div>
                                    </div>
                                </div>
                            ...
                            <div>
                                <form action="" autocomplete="false" method="post">
                                    <div class="form-row">
                                        ...
                                        <div class="col-md-6">
                                            <div class="position-relative form-group"><label for="password" class="">Password</label><input name="password" id="password" placeholder="Password here..." type="password" class="form-control"></div>
                                        </div>
                                    </div>
