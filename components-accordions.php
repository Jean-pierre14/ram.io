...
<!-- Mirrored from demo.dashboardpack.com/kero-html-sidebar-pro/components-accordions.html by HTTrack Website Copier/3.x [XR&CO'2014], Sat, 01 May 2021 14:53:50 GMT -->
                                            ...
                                            <div class="col-md-6">
                                                <div class="main-card mb-3 card">
                                                    <div class="card-body">
                                                        ...
                                                        <div class="collapse" id="collapseExample123"><p>Anim pariatur
                                                            ...
                                                            proident.</p>
                                                            <p>Donec molestie odio id nisi malesuada, mattis tincidunt velit
                                                                egestas. Sed non pulvinar risus. Aenean elementum eleifend
                                                                nunc, pellentesque dapibus arcu hendrerit fringilla. Aliquam
                                                                in nibh massa. Cras
                                                                ultricies
                                                                lorem non enim volutpat, a eleifend urna placerat. Fusce id
                                                                luctus urna. In sed leo tellus. Mauris tristique leo a nisl
                                                                feugiat, eget vehicula leo venenatis. Quisque magna metus,
                                                                luctus quis sollicitudin
                                                                vel,
                                                                vehicula nec ipsum. Donec rutrum commodo lacus ut
                                                                condimentum. Integer vel turpis purus. Etiam vehicula, nulla
                                                                non fringilla blandit, massa purus faucibus tellus, a luctus
                                                                enim orci non augue. Aenean
                                                                ...
                                                                leo elit laoreet arcu, vehicula
                                                                sagittis elit leo id nisi.</p></div>
                                                    </div>
                                                    <div class="card-footer">
                                                        <button type="button" data-toggle="collapse"
                                                                href="#collapseExample123" class="btn btn-primary">Toggle
                                                        </button>
                                                    </div>
                                                </div>
                                                <div class="main-card mb-3 card">
                                                        ...
                                                        <div id="exampleAccordion" data-children=".item">
                                                            <div class="item">
                                                                <button type="button" aria-expanded="true"
                                                                        ...
                                                                        class="m-0 p-0 btn btn-link">Toggle item
                                                                </button>
                                                                <div data-parent="#exampleAccordion" id="collapseExample"
                                                                     class="collapse show"><p class="mb-3">Lorem ipsum dolor
                                                            ...
                                                            <div class="item">
                                                                ...
                                                                <div data-parent="#exampleAccordion" id="collapseExample2"
                                                                    ...
                                                                    dis parturient montes, nascetur ridiculus mus.</p></div>
                                                            </div>
                                                        </div>
                                                    </div>
                                                </div>
